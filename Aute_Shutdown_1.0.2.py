...
Button = 0  #定义记录按钮变量
Button = gui.buttonbox(msg='您好，欢迎！我可以关闭或重启您的计算机。'+'Aute Shutdown V1.0.2 By Feather  Github：Feather-code107  项目地址：https://github.com/Feather-code107/Aute_Shutdown'+'使用的开源项目：EasyGUI；基于 Python；使用 Pyinstaller 打包。',title = '主页 - Aute Shutdown 1.0.1',choices=('退出程序','下一步'))
#主页对话框
#判断对话框选项
        ...
        if Button == '退出程序':  #退出按钮，结束程序
            ...
            if Button == '关闭':  #关闭选项
                ...
                if Button == '退出程序':  #退出程序
                    ...
                    gui.msgbox(msg='您的计算机将要关机。',title='关机 - Aute Shutdown V1.0.1')
                ...
                if Button == '退出程序':  #退出程序
                    ...
                    gui.msgbox(msg='您的计算机将要重启。',title='重启 - Aute Shutdown V1.0.1')
